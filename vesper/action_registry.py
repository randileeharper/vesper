...
ACTION_DEFINITIONS: tuple[ActionDefinition, ...] = (
    ...
    _definition("play_candidate_match", "Resolve candidate tracks or queries into playback.", "play candidate match", lambda service, params: service.play_candidate_match(candidate_tracks=list(params.get("candidate_tracks") or []) or None, candidate_queries=list(params.get("candidate_queries") or params.get("candidate_query") or []) or None, storefront=str(params.get("storefront", "us")))),

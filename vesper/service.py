...
class CiderAgentService:
    ...
    def session_status(self, *, include_recent_tracks: bool = True, compact: bool | None = None) -> dict[str, Any]:
        ...
        if session is None:
            ...
            return compact_output(payload, self.include_timing_debug()) if compact is not False and self.response_detail() == "compact" else payload
        ...
        if compact is True or self.response_detail() == "compact":
            return compact_output(payload, self.include_timing_debug())
        return payload
